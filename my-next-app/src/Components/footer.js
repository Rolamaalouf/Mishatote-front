...
const Footer = () => {
  return (
    <footer className="bg-[#F8F8F8] text-black py-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="flex justify-center md:justify-end gap-6">
          <a href="https://wa.me/9613734990" target="_blank" rel="noopener noreferrer">
            <FaWhatsapp className="text-3xl text-[#4A8C8C] hover:text-black transition duration-300" />
          </a>
          <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
            <FaInstagram className="text-3xl text-[#4A8C8C] hover:text-black transition duration-300" />
          </a>
          <a href="mailto:your-email@example.com">
            <FaEnvelope className="text-3xl text-[#4A8C8C] hover:text-black transition duration-300" />
          </a>
        </div>
